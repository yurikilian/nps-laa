...
@Singleton
public class EndpointCountPerRegionAnalytics extends AbstractAnalyticsProcessor {

    private final Logger logger = LoggerFactory.getLogger(EndpointCountPerRegionAnalytics.class);

    public EndpointCountPerRegionAnalytics(@Value("${database}") String database,
